...
**Progress:** Small-batch dense and grouped-MoE crossovers are closed by
results 25a/25b below. Whole-prompt chunk size and DeltaNet chunk geometry
remain active sub-levers.
